...
public class AutoSubsystem extends SubsystemBase {
    ...
    public static Command AutoVision(CoralSubsystem coralHandlerSubsystem, VisionSubsystem visionSubsystem, CommandSwerveDrivetrain drivetrain) {
    ...
    public static Command StopVision(CoralSubsystem coralHandlerSubsystem, VisionSubsystem visionSubsystem, CommandSwerveDrivetrain drivetrain) {
        return new AutoVisionCommand(coralHandlerSubsystem,visionSubsystem,drivetrain, false);
    }
    //Drop the Coral, get Algae at L2 
    public static Command AutoExchange(CoralSubsystem coralHandlerSubsystem, ElevatorSubsystem elevatorSubsystem, AlgaeSubsystem algaeSubsystem){
    ...
    public static Command Scoral(CoralSubsystem coralHandlerSubsystem){
        logger.info("Executing Coral score Auto Mode");
        return new AutoCoralReleaseCommand(coralHandlerSubsystem);
    }

    public static Command AutoIntake(CoralSubsystem coralHandlerSubsystem){
        logger.info("Executing Intake Mode");
        return new AutoIntakeCommand(coralHandlerSubsystem);
    }

    public static Command Stopal(CoralSubsystem coralHandlerSubsystem){
